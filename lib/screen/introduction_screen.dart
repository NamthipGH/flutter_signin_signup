  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        centerTitle: true,
        backgroundColor: Color.fromARGB(255, 188, 255, 196),
      ),
      body: IntroductionScreen(
        globalBackgroundColor: const Color.fromARGB(255, 229, 255, 232),
        pages: pages,
        showSkipButton: true,
        ...
        dotsDecorator: const DotsDecorator(
          size: Size(15, 15),
          color: Color.fromARGB(255, 91, 255, 110),
          activeColor: Color.fromARGB(255, 226, 255, 64),
